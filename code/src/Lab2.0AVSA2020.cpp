...
//		// "/home/avsa/datasets/...
		string dataset_path = "/home/avsa/avsa/lab2/2020AVSALab3_datasets/"; //SET THIS DIRECTORY according to your download
...
//		string image_path = "/input/in%06d.jpg"; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
	...
	//	string image_path = ""; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
		...
		string project_root_path = "/home/avsa/avsa/lab2/"; //SET THIS DIRECTORY according to your project
		string project_name = "Lab2.0src"; //SET THIS DIRECTORY according to your project
		...
		for (int c=0; c<NumCat; c++ )
		{
			...
			for (;;) {
				...
				img.copyTo(frame);
				// Compute fgmask
				double learningrate=0.0003; //default value (as starting point)
				...
				int min_width=20;  // to set properly
				int min_height=20; // to set properly
